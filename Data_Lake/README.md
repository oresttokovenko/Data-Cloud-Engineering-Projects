...
In this project, I built an ETL pipeline for a data lake hosted on S3. It will load data from S3, process the data into analytics tables using Spark, and load it back into S3. I will deploy this Spark process on a cluster using AWS.
